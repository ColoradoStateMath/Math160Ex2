...
derivative. In order to formally know why this is true, we need to call upon the 
the \textit{Binomial Theorem}, which you may or may not have heard
of in a statistics class or some algebra classess.
...
\begin{explanation}
We will only prove part (from part a of the above theorem) above;
the rest are similar. Write with me
\begin{image}
  \begin{tikzpicture}
    \node at (0,0) {$\begin{aligned}
